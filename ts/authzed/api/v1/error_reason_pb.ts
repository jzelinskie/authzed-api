...
// @generated from file authzed/api/v1/error_reason.proto (package authzed.api.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum authzed.api.v1.ErrorReason
 */
export enum ErrorReason {
   ...
   *
   * @generated from enum value: ERROR_REASON_SCHEMA_PARSE_ERROR = 1;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_SCHEMA_TYPE_ERROR = 2;
   */
  SCHEMA_TYPE_ERROR = 2,
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_UNKNOWN_DEFINITION = 3;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_UNKNOWN_RELATION_OR_PERMISSION = 4;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_TOO_MANY_UPDATES_IN_REQUEST = 5;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_TOO_MANY_PRECONDITIONS_IN_REQUEST = 6;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_WRITE_OR_DELETE_PRECONDITION_FAILURE = 7;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_SERVICE_READ_ONLY = 8;
   */
  SERVICE_READ_ONLY = 8,
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_UNKNOWN_CAVEAT = 9;
   */
  UNKNOWN_CAVEAT = 9,
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_INVALID_SUBJECT_TYPE = 10;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_CAVEAT_PARAMETER_TYPE_ERROR = 11;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_UPDATES_ON_SAME_RELATIONSHIP = 12;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_CANNOT_UPDATE_PERMISSION = 13;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_CAVEAT_EVALUATION_ERROR = 14;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_INVALID_CURSOR = 15;
   */
  INVALID_CURSOR = 15,
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_TOO_MANY_RELATIONSHIPS_FOR_TRANSACTIONAL_DELETE = 16;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_MAX_RELATIONSHIP_CONTEXT_SIZE = 17;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_ATTEMPT_TO_RECREATE_RELATIONSHIP = 18;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_MAXIMUM_DEPTH_EXCEEDED = 19;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_SERIALIZATION_FAILURE = 20;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_TOO_MANY_CHECKS_IN_REQUEST = 21;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_EXCEEDS_MAXIMUM_ALLOWABLE_LIMIT = 22;
   */
  EXCEEDS_MAXIMUM_ALLOWABLE_LIMIT = 22,
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_INVALID_FILTER = 23;
   */
  INVALID_FILTER = 23,
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_INMEMORY_TOO_MANY_CONCURRENT_UPDATES = 24;
   */
  INMEMORY_TOO_MANY_CONCURRENT_UPDATES = 24,
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_EMPTY_PRECONDITION = 25;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_COUNTER_ALREADY_REGISTERED = 26;
   */
   ...
   *     }
   *
   * @generated from enum value: ERROR_REASON_COUNTER_NOT_REGISTERED = 27;
   */
...
proto3.util.setEnumType(ErrorReason, "authzed.api.v1.ErrorReason", [
  ...
  { no: 1, name: "ERROR_REASON_SCHEMA_PARSE_ERROR" },
  { no: 2, name: "ERROR_REASON_SCHEMA_TYPE_ERROR" },
  { no: 3, name: "ERROR_REASON_UNKNOWN_DEFINITION" },
  { no: 4, name: "ERROR_REASON_UNKNOWN_RELATION_OR_PERMISSION" },
  { no: 5, name: "ERROR_REASON_TOO_MANY_UPDATES_IN_REQUEST" },
  { no: 6, name: "ERROR_REASON_TOO_MANY_PRECONDITIONS_IN_REQUEST" },
  { no: 7, name: "ERROR_REASON_WRITE_OR_DELETE_PRECONDITION_FAILURE" },
  { no: 8, name: "ERROR_REASON_SERVICE_READ_ONLY" },
  { no: 9, name: "ERROR_REASON_UNKNOWN_CAVEAT" },
  { no: 10, name: "ERROR_REASON_INVALID_SUBJECT_TYPE" },
  { no: 11, name: "ERROR_REASON_CAVEAT_PARAMETER_TYPE_ERROR" },
  { no: 12, name: "ERROR_REASON_UPDATES_ON_SAME_RELATIONSHIP" },
  { no: 13, name: "ERROR_REASON_CANNOT_UPDATE_PERMISSION" },
  { no: 14, name: "ERROR_REASON_CAVEAT_EVALUATION_ERROR" },
  { no: 15, name: "ERROR_REASON_INVALID_CURSOR" },
  { no: 16, name: "ERROR_REASON_TOO_MANY_RELATIONSHIPS_FOR_TRANSACTIONAL_DELETE" },
  { no: 17, name: "ERROR_REASON_MAX_RELATIONSHIP_CONTEXT_SIZE" },
  { no: 18, name: "ERROR_REASON_ATTEMPT_TO_RECREATE_RELATIONSHIP" },
  { no: 19, name: "ERROR_REASON_MAXIMUM_DEPTH_EXCEEDED" },
  { no: 20, name: "ERROR_REASON_SERIALIZATION_FAILURE" },
  { no: 21, name: "ERROR_REASON_TOO_MANY_CHECKS_IN_REQUEST" },
  { no: 22, name: "ERROR_REASON_EXCEEDS_MAXIMUM_ALLOWABLE_LIMIT" },
  { no: 23, name: "ERROR_REASON_INVALID_FILTER" },
  { no: 24, name: "ERROR_REASON_INMEMORY_TOO_MANY_CONCURRENT_UPDATES" },
  { no: 25, name: "ERROR_REASON_EMPTY_PRECONDITION" },
